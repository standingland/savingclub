...
export function Dashboard({ goCreate, openPay }) {
  return (
    <section style={{ animation: 'wj-in .4s var(--ease-brand)' }}>
      <div style={{ display: 'flex', alignItems: 'baseline', justifyContent: 'space-between', gap: 16, flexWrap: 'wrap' }}>
        <div>
          ...
          <h1 style={{ fontSize: 30, marginTop: 6, fontFamily: 'var(--font-body)', fontWeight: 700, letterSpacing: '-0.01em' }}>สวัสดี</h1>
        </div>
      </div>
      ...
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginTop: 30 }}>
        <div style={{ fontFamily: 'var(--font-mono)', fontSize: 10, letterSpacing: '.18em', textTransform: 'uppercase', color: 'hsl(var(--muted-foreground))' }}>วงแชร์ของฉัน · 0</div>
      ...
      >
        <div style={{ fontSize: 14, fontWeight: 700 }}>ยังไม่มีวงแชร์</div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit,minmax(320px,1fr))', gap: 14, marginTop: 16, alignItems: 'start' }}>
        ...
        <div className="glass-card" style={{ borderRadius: 'var(--radius-xl)', padding: 20, display: 'flex', alignItems: 'center', gap: 18 }}>
          ...
          >
            ...
            >
              <span style={{ fontFamily: 'var(--font-display)', fontSize: 22, fontWeight: 700, lineHeight: 1, color: 'hsl(var(--muted-foreground))' }}>—</span>
            </div>
          </div>
          <div>
            ...
            <div style={{ fontSize: 14, fontWeight: 700, marginTop: 5 }}>ยังไม่มีคะแนน</div>
            <div style={{ fontSize: 11.5, color: 'hsl(var(--muted-foreground))', marginTop: 3, lineHeight: 1.6 }}>
              คะแนนจะเริ่มคำนวณเมื่อคุณชำระค่างวดงวดแรก
            </div>
          </div>
        </div>
      </div>
